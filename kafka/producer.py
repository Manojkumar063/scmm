...
# TCP config
SERVER_HOST = '192.168.60.35'  # Change to 'localhost' if needed
SERVER_PORT = 5050
FORMAT = 'utf-8'

# Kafka config
KAFKA_TOPIC = 'device-data'
KAFKA_BOOTSTRAP_SERVERS = '192.168.60.35:9092'  # Adjust to your Kafka
...
# Read from socket and send to Kafka
try:
    while True:
