...
from backend.app.database import get_database_status

# Routers
from backend.app.routers.login_route import router as login_router
from backend.app.routers.signup_route import router as signup_router
from backend.app.routers.logout_route import router as logout_router
from backend.app.routers.dashboard_route import router as dashboard_router
from backend.app.routers.device_data_route import router as device_data_router
from backend.app.routers.my_shipment_route import router as my_shipment_router
from backend.app.routers.new_shipment_route import router as new_shipment_router
from backend.app.routers.user_route import router as user_router
...
# Ensure the static and templates directories exist before mounting
if not os.path.exists("backend/app/static"):
    os.makedirs("backend/app/static", exist_ok=True)
if not os.path.exists("backend/app/templates"):
    os.makedirs("backend/app/templates", exist_ok=True)
